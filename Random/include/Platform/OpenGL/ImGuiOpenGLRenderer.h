...
//  [X] Renderer: User texture binding. Use 'GLuint' OpenGL texture as texture identifier. Read the FAQ about
//  ImTextureID/ImTextureRef! [x] Renderer: Large meshes support (64k+ vertices) even with 16-bit indices
//  (ImGuiBackendFlags_RendererHasVtxOffset) [Desktop OpenGL only!] [X] Renderer: Texture updates support for dynamic
//  font atlas (ImGuiBackendFlags_RendererHasTextures).
